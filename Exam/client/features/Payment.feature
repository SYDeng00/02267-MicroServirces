...
Feature: Payment
  ...
  Scenario: Payment from customer to merchant
    Given the customer "First_C01ssds0ddd010" "Last_C00d1s1sw0dd1s0" with CPR "121ddsdssd3dsdd0s00s10" with balance 1000
    And the customer has registered with DTUPay
    And the merchant "First_M0ssdsddd10010" "Lasst_M1sd0d0ds010" with CPR "454d6ssddsd0sddds1s0010" with balance 1000
